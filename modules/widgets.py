...
class OrangeButton(QPushButton):
    def __init__(self, text, icon=""):
        ...
        self.setStyleSheet(f"""
            ...
            QPushButton:hover {{ background: {NAVY_HOVER}; }}
            QPushButton:pressed {{ background: {NAVY_PRESSED}; }}
        """)
...
class SearchBar(QLineEdit):
    def __init__(self, placeholder="Search…"):
        ...
        self.setStyleSheet(f"""
            ...
            QLineEdit:focus {{ border: 1px solid #0b1f3a; }}
        """)
    ...
    def __init__(self, columns: list):
        ...
        self.setStyleSheet(f"""
            QTableWidget {{
                ...
                font-size: 13px; color: {TEXT_DARK};
                selection-background-color: #e7eef8;
                selection-color: {TEXT_DARK};
                outline: none;
            }}
            QHeaderView::section {{
                background: {PAGE_BG}; color: {TEXT_SOFT};
